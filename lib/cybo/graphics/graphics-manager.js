define ([
    ...
    function GraphicsManager(_xcene) {
        ...
        function setUpWebGLRenderingContext() {
            ...
            setUpWebGLRenderingContextConstants();
        ...
        function setUpWebGLRenderingContextConstants() {
            //
            if (WebGLRenderingContext.DEPTH_BUFFER_BIT === undefined) {
                //
                Object.defineProperty(WebGLRenderingContext, "DEPTH_BUFFER_BIT", {
                    get: function() { return _renderingContext.DEPTH_BUFFER_BIT; }
                });
            }
            
            if (WebGLRenderingContext.STENCIL_BUFFER_BIT === undefined) {
                //
                // Test:
                alert (
                    "[before]\n" +
                    ...
                    WebGLRenderingContext.STENCIL_BUFFER_BIT + "\n" +
                    "_renderingContext.STENCIL_BUFFER_BIT = " +
                    _renderingContext.STENCIL_BUFFER_BIT
                );
                // :Test

                Object.defineProperty(WebGLRenderingContext, "STENCIL_BUFFER_BIT", {
                    get: function() { return _renderingContext.STENCIL_BUFFER_BIT; }
                });
            ...
            if (WebGLRenderingContext.COLOR_BUFFER_BIT === undefined) {
                //
                Object.defineProperty(WebGLRenderingContext, "COLOR_BUFFER_BIT", {
                    get: function() { return _renderingContext.COLOR_BUFFER_BIT; }
                });
            }
        }
    }
